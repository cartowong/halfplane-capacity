...
\begin{frame}
  ...
  \vspace{-0.8in}  
  \begin{figure}
    \includegraphics{figures/radial_f(z,t).pdf}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \end{question}
  \begin{figure}
    \includegraphics[scale=0.3]{figures/radialSlit_02.pdf}
  \end{figure}
  \begin{answer}
...
\begin{frame}
  ...
  \vspace{-0.4in}
  \begin{figure}
    \includegraphics[scale=0.9]{figures/radial_f(z,t)_02.pdf}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \vspace{-0.3in}
  \begin{figure}
    \includegraphics[scale=0.6]{figures/chordal_f(z,t).pdf}
  \end{figure}
  \onslide<3->{
  \begin{example}
